...
class TestCustomerRoutes:
    ...
    def test_create_customer(self, client):
        ...
        response = client.post("/customers/create", data=json.dumps(data), content_type="application/json")
    ...
    def test_update_customer(self, client, sample_customer):
        ...
        response = client.put(
            f"/customers/{sample_customer.id}", data=json.dumps(update_data), content_type="application/json"
        )
...
class TestInvoiceRoutes:
    ...
    def test_create_invoice(self, client, sample_customer):
        ...
        response = client.post("/invoices/create", data=json.dumps(data), content_type="application/json")
    ...
    def test_update_invoice(self, client, sample_invoice):
        ...
        response = client.put(
            f"/invoices/{sample_invoice.id}", data=json.dumps(update_data), content_type="application/json"
        )
